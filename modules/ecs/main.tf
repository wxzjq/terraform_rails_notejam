...
resource "aws_alb_listener" "rails_terraform1" {
...
resource "aws_alb_listener" "rails_terraform2" {
  load_balancer_arn = aws_alb.alb_rails-terraform.arn
  port              = "443"
  protocol          = "HTTPS"
  ssl_policy        = "ELBSecurityPolicy-2016-08"
  certificate_arn   = "arn:aws:acm:us-east-1:202848614748:certificate/6794b513-c6b3-4269-9cad-97f6a42b3c65"
  depends_on        = ["aws_alb_target_group.alb_target_group"]
